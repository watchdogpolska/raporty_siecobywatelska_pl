"""
Base settings for Raporty Siec Obywatelska project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (raporty_siecobywatelska_pl/config/settings/base.py - 3 = raporty_siecobywatelska_pl/)
APPS_DIR = ROOT_DIR.path('raporty_siecobywatelska_pl')
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'raporty_siecobywatelska_pl.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Kamil Bregula""", 'kamil.bregula@siecobywatelska.pl'),
]
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///raporty_siecobywatelska_pl'),
}
...
SOCIALACCOUNT_ADAPTER = 'raporty_siecobywatelska_pl.users.adapters.SocialAccountAdapter'
...
# Celery
# ------------------------------------------------------------------------------
INSTALLED_APPS += ['raporty_siecobywatelska_pl.taskapp.celery.CeleryAppConfig']
if USE_TZ:
...
CELERY_BEAT_SCHEDULE = {
    'send-summary-every-hour': {
       'task': 'taskapp:send-notification',
